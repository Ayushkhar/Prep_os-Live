...
<ref *1> Mongoose {
  connections: [
    NativeConnection {
      ...
      _connectionString: 'mongodb+srv://ayushkhare:ayushkhare@cluster0.z8h1yw8.mongodb.net//examprep',
      client: [MongoClient],
      '$initialConnection': [Promise],
      db: [Db],
      host: 'ac-olobkxn-shard-00-00.z8h1yw8.mongodb.net',
      port: 27017,
      name: '/examprep',
  ...
  Types: {
    ...
    ObjectId: [class ObjectId extends BSONValue] {
      index: 15582971,
      PROCESS_UNIQUE: <Buffer ce 98 8e 00 41>,
